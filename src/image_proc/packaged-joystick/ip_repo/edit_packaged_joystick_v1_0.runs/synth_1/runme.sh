...
HD_PWD='C:/Users/Jash/Desktop/packaged joystick/ip_repo/edit_packaged_joystick_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log packaged_joystick_v1_0.vds -m64 -mode batch -messageDb vivado.pb -notrace -source packaged_joystick_v1_0.tcl
