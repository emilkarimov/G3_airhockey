...
HD_PWD='c:/xilinx/projects/stable_puck_detection/ip_repo/edit_stable_puck_detection_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log stable_puck_detection_v1_0.vds -m64 -mode batch -messageDb vivado.pb -notrace -source stable_puck_detection_v1_0.tcl
